...
@RolesAllowed("query")
@RegisterRestClient(configKey = "bizlocations-api")
public interface BizLocationsTopLevelApi {
            ...
            value = {
                    @APIResponse(
                            ...
                            @Content(
                                    ...
                                    example = ResponseBodyExamples.RESPONSE_200_TOP_LEVEL_OR_BIZLOCATION_ENDPOINT)),
                    @APIResponse(
                            responseCode = "401",
    ...
    Uni<Response> getBizLocations(@Context SecurityIdentity securityIdentity,
                                  @Valid
                                  @RestQuery
    ...
    @Parameters(
            value = {
                    @Parameter(
                            ...
                            in = ParameterIn.QUERY,
                            content = @Content(example = DEFAULT_PER_PAGE_PARAMETER_VALUE)),
                    @Parameter(description = "", required = true, in = ParameterIn.PATH, example = "urn:epc:id:sgln:0012345.11111.0")
            }
    )
    @APIResponses(
            value = {
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getSubResourceOfBizLocation(@Context SecurityIdentity securityIdentity,
                                              @Context UriInfo uriInfo, @RestPath String bizLocation);
    ...
    @Parameters(
            value = {
                    @Parameter(
                            description = ParameterDescriptions.BIZ_LOCATION,
                            required = true,
                            in = ParameterIn.PATH),
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getEventsFromBizLocations(
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getBizLocationsOptions();
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> bizLocationOptions(@RestPath String bizLocation);
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> bizLocationEventsOptions(@RestPath String bizLocation);
