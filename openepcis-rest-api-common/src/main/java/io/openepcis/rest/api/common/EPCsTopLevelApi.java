...
@RolesAllowed("query")
@RegisterRestClient(configKey = "epcs-api")
public interface EPCsTopLevelApi {
            ...
            value = {
                    @APIResponse(
                            ...
                            @Content(
                                    ...
                                    example = ResponseBodyExamples.RESPONSE_200_TOP_LEVEL_OR_EPC_ENDPOINT)),
                    @APIResponse(
                            responseCode = "401",
    ...
    Uni<Response> getEPCS(@Context SecurityIdentity securityIdentity,
                          @Valid
                          @RestQuery
    ...
    @Parameters(
            value = {
                    @Parameter(description = "An electronic product code value.", required = true, in = ParameterIn.PATH, example = "Example : urn:epc:id:sgtin:0614141.107346.2018"),
                    @Parameter(
                            name = "GS1-Extensions",
                            description = ParameterDescriptions.GS1_EXTENSIONS,
                            in = ParameterIn.HEADER)
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getSubResourceOfEPC(@Context SecurityIdentity securityIdentity,
                                      @Context UriInfo uriInfo,@RestPath String epc);
    ...
    @Parameters(
            value = {
                    @Parameter(description = ParameterDescriptions.EPC, required = true, in = ParameterIn.PATH),
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getEventsFromEPCS(
    ...
    @Parameters(
            value = {
                    @Parameter(description = ParameterDescriptions.EPC, required = true, in = ParameterIn.PATH, example = "urn:epc:id:sgtin:0614141.107346.2018"),
                    @Parameter(
                            name = "GS1-Extensions",
                            description = ParameterDescriptions.GS1_EXTENSIONS,
                            in = ParameterIn.HEADER)
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> epcOptions(@RestPath String epc);
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> epcEventsOptions(@RestPath String epc);
}
