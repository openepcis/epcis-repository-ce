...
@RolesAllowed("query")
@RegisterRestClient(configKey = "disposition-api")
public interface DispositionsTopLevelApi {
            ...
            value = {
                    @APIResponse(
                            ...
                            @Content(
                                    ...
                                    example = ResponseBodyExamples.RESPONSE_200_SUPPORTED_DISPOSITIONS)),
                    @APIResponse(
                            responseCode = "401",
    ...
    Uni<Response> getDispositions(@Context SecurityIdentity securityIdentity,
                                  @Valid
                                  @RestQuery
    ...
    @Parameters(
            value = {
                    @Parameter(description = "A disposition value.", required = true, in = ParameterIn.PATH, example = "in_progress"),
                    @Parameter(
                            name = "GS1-Extensions",
                            description = ParameterDescriptions.GS1_EXTENSIONS,
                            in = ParameterIn.HEADER)
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getSubResourceOfDisposition(@Context SecurityIdentity securityIdentity,
                                              @Context UriInfo uriInfo, @RestPath String disposition);
    ...
    @Parameters(
            value = {
                    @Parameter(
                            description = ParameterDescriptions.DISPOSITION,
                            required = true,
                            in = ParameterIn.PATH),
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getEventsFromDispositions(
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> getDispositionsOptions();
    ...
    @Produces({MediaType.APPLICATION_JSON, "application/problem+json", "application/ld+json"})
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> dispositionOptions(@RestPath String disposition);
    ...
    @Consumes({MediaType.APPLICATION_JSON, "application/ld+json"})
    Uni<Response> dispositionEventsOptions(@RestPath String disposition);
